...
describe('DbAddAccount Usecase', () => {
  ...
  // esse teste garante que na classe de producao ninguem implente com try, catch porque ..
  // .. o error tem que caminhar e ser capturado por quem chama
